    ...
    if (isMobile(width)) {
      ...
      for(var i in columns) {
        switch(columns[i].column_type) {
          case 'home':
            customColumns.push(<HomeTimeline key={i} custom={true} shouldUpdateScroll={noOp}/>);
            break;
          case 'local':
            customColumns.push(<CommunityTimeline key={i} custom={true} shouldUpdateScroll={noOp}/>);
            break;
          case 'federated':
            customColumns.push(<PublicTimeline key={i} custom={true} shouldUpdateScroll={noOp}/>);
            break;
          case 'notifications':
            customColumns.push(<Notifications key={i} custom={true} shouldUpdateScroll={noOp}/>);
            break;
        }
      }
